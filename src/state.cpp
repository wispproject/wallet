...
// Copyright (c) 2016-2018 The SpectreCoin developers
// Copyright (c) 2018 The Wisp developers
...
int nStakingDonation = 10;          // percentage of stakes that will be donated to the developers
