...
"for example: alertnotify=echo %%s | mail -s \"SpectreCoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Cannot obtain a lock on data directory %s.  SpectreCoin is probably already "
"running."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of SpectreCoin"),
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart SpectreCoin to complete"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Unable to bind to %s on this computer. SpectreCoin is probably already running."),
...
"your clock is wrong SpectreCoin will not work properly."),
